...
from posts.crud import create_post, get_post_by_id, get_own_post, get_all_own_posts, \
    update_post, delete_existing_post, create_like, get_like, delete_like, \
    add_cache_like, remove_cache_like, remove_cache_post, get_cache_likes, check_cache_like
...
async def delete_post(post_id: int, db: Session = Depends(get_db),
    ...
    # Delete the post from DB (with likes/dislikes)
